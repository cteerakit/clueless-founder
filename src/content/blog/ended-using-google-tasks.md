...
I’ll be using this app for personal tasks only. This includes paying monthly credit cards, doing laundry and groceries, meeting with the dentist, and other day-to-day small tasks. I’ll use another project management app for work separately (I use Asana for work).
It has to be some kind of checklist where tasks can be checked off as a clear indication of completion.
It should be easy to jump in, no initial setup is required.
It has to be able to create recurring tasks as most of them will be repeating.
It should work on all devices. I use a Windows PC and an Android phone. But to be safe, it should work on Mac, iOS, and web browsers.
And finally, it should be free as it is for personal use.
