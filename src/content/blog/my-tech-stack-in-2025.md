...
### Office software: [Google Workspace](https://workspace.google.com/)

There are a few players in this space: [Microsoft 365](https://www.microsoft.com/en-us/microsoft-365/), Google Workspace, [Lark](https://www.larksuite.com/), and a few others.
...
The cool thing about all this is, that with [Cloudflare Email Routing](https://www.cloudflare.com/developer-platform/products/email-routing/), I can have business email in my regular Gmail account with no additional cost. I can get around with this for a while. However, it’s not a secure way to set up, so not recommended for bigger teams.

Sadly, there’s no project management tool in their suite, so I need another tool for this. And they lack database tools. I find myself still using [Airtable](https://airtable.com/) for some type of work.
...
### Project management: [Todoist](https://www.todoist.com/)

Back then at my previous company, my personal and work life were clearly separated. So I used two different tools for each purpose: [Google Tasks](https://tasks.google.com) for personal and [Asana](https://asana.com/) for work stuff.
...
### Team communication: [Discord](https://discord.com/)

There are many great chat apps for teams. [Slack](https://slack.com/), MS Teams, Google Chat, Lark, etc. But I find Discord fits my needs.
...
### Knowledge base: [Google Docs](https://docs.google.com/) + [Gitbook](https://www.gitbook.com/)
...
### Note-taking: [Google Keep](https://keep.google.com/)
...
### AI: [Gemini](https://gemini.google.com/)+ [ChatGPT](https://chatgpt.com/)

I talk to AI a lot, at least 3 conversations every single day. I find Gemini is best for general purposes while ChatGPT is better for some specific topics like coding. I will also keep an eye on [DeepSeek](https://www.deepseek.com/) this year.

### Automation: [Make](https://www.make.com/en) + [Relay](https://relay.app/)

Automation is the key to running a small team as it eliminates routine tasks entirely, allowing you and your team to focus on other matters. [Zapier](https://zapier.com/) is the most well-known in the category but I find it too expensive.
...
### Front-end: [Toddle](https://toddle.cello.so/fVlhlfHKOjM)
...
Last year, I started building my app with [WeWeb](https://www.weweb.io/), a web app builder. While they’re great in what they do, I find it lacks SEO functionality which my business relies on a lot. So this year, I migrated almost everything to Toddle.
...
In my roadmap, I will need to build native apps on Android and iOS too. [Flutterflow](https://www.flutterflow.io/) looks promising. I will share my experience later this year.
...
This section will vary across the different types of businesses you’re in. For most businesses, all you need is a way to store data and a portal for your team to access and manage them. Tools like Airtable, Notion, [Glide](https://join.glideapps.com/n7a2437aoo5y), Lark Base, or [AppSheet](https://about.appsheet.com/)will be your best bet.
...
There are a few tools in this internal tool space. [Budibase](https://budibase.com/) is great for simple databases. Mine is quite complex so I chose Retool.

### Content Management System (CMS): [Hygraph](https://hygraph.com/) + [Contentful](https://www.contentful.com/)
...
### Planning: [Linear](https://linear.app/)
...
### Notification: [Mailersend](https://www.mailersend.com/) + [Loops](https://loops.so/)

For email notifications, Mailersend does the job. If you are a coder you may want to checkout [Resend](https://resend.com/). Loops is another great option built for software companies specifically. It’s a bit more expensive so I keep this for my B2B customers.

Another aspect that I haven’t looked into is push notifications. I will try [Knock](https://knock.app/), [Onesignal](https://onesignal.com/)later.

### Payment: [Stripe](https://stripe.com/)

I chose Stripe because it’s easy to implement as a no-coder. If I can code, I would explore other options like [Opn](https://www.omise.co/) and [2C2P](https://2c2p.com/). But as of now, Stripe is good enough.

### Tag management: [Cloudflare Zaraz](https://www.cloudflare.com/application-services/products/zaraz/) + [Google Tag Manager](https://tagmanager.google.com/)
...
### General-purpose: [Figma](https://www.figma.com/)
...
For most people, just go with [Canva](https://www.canva.com/).
...
There are other great UI kits like [Untitled UI](https://www.untitledui.com/), [Ant](https://www.antforfigma.com/), [Stratis](https://www.stratisui.com/), and more. Just choose whichever you like.

### Design Materials: [Lucide](https://lucide.dev/)
...
### Marketing analytics: [Google Analytics](https://marketingplatform.google.com/about/analytics/)
...
### Email marketing: [MailerLite](https://www.mailerlite.com/invite/e7ae6e8990366)

MailerLite is great at one thing, email. It has great email tools, segmentation, grouping, automation, and reasonable prices.

While they also offer other tools like website and landing page builder, they’re not the best. If you want an all-in-one solution, [Brevo](https://www.brevo.com/) is a great option.

### Search Engine Optimization (SEO): [Search Console](https://search.google.com/search-console/about) + [Ahrefs](https://ahrefs.com/)

I find the Search Console and the free version of Ahrefs are good enough to keep me busy for a while.

Some other useful tools are [Keyword Planner](https://ads.google.com/aw/keywordplanner/), [Semrush](https://www.semrush.com/), [Ubersuggest](https://app.neilpatel.com/).

### Content marketing: [Publer](https://publer.com/)

If you need to post to multiple social media, Publer or [Buffer](https://buffer.com/) are great. They are similar in many ways so whatever you pick will be good.
...
### Advertising: [Google Ads](https://ads.google.com/) + [Meta](https://business.meta.com/)

While I focus on organic growth, I do run some ads focusing on the B2B side of the business. And when it comes to online ads, you can’t get away from these big ad networks. For B2C business, you may want to include [TikTok ads](https://ads.tiktok.com/business/en) too.

### Dashboard: [Datapad](https://www.datapad.io/)
...
### Customer Relationship Management (CRM): [Attio](https://attio.com/)

I like Attio that it focuses on being just a CRM. This makes it easy to use and affordable. [Folk](https://www.folk.app/) is another one similar to Attio.

These tools are geared toward small teams. If you’re in a big team, you may consider [Salesforce](https://www.salesforce.com/) or [HubSpot](https://www.hubspot.com/).

### Outreach: [Apollo](https://get.apollo.io/6zmpgmxtjfr1)

I’m too lazy to write and send emails one by one. Apollo helps me do exactly that but at scale.

### Scheduling: [Cal.com](https://refer.cal.com/cteerakit)

I use this for scheduling meetings, avoiding the back-and-forth of endless emails. And it’s better than [Calendly](https://calendly.com/). If you’re on Google Workspace, you can just use the appointment feature built-in to Calendar.

### Customer support: [Helpscout](https://www.helpscout.com/)
...
### Bookkeeping: [Peak](https://www.peakaccount.com/)
...
While I prefer [Xero](https://www.xero.com/)’s integration with other apps, Peak works well in my country (Thailand) as it covers local requirements better like tax documents.

[FlowAccount](https://flowaccount.com/) is another great option but it lacks bank reconciliation. In Peak, you will be able to import your bank statement and be able to map each statement line to the transaction in the platform. This makes sure you won’t miss a single line in the statement. In FlowAccount, you need to do this manually which is a pain🥲.

### Banking: [K BIZ](https://www.kasikornbank.com/th/kbiz/pages/index.aspx)
...
[signNow](https://www.signnow.com/) is another good option if you need to sign more documents.
