...
- **First, I Just Ask AI.** We're in 2025, so use the tools you have! If I’m facing a problem, I'll go to [Gemini](https://gemini.google.com) and literally type in my problem, then ask it to recommend a book to help me solve it. It’s like having a personal librarian.
...
I used to have an [Amazon Kindle Paperwhite](https://www.amazon.com/Kindle-Paperwhite-adjustable-Ad-Supported/dp/B08KTZ8249), which was great, but I didn't like being locked into the Amazon store. So, I switched to the [Onyx Boox Poke 4 Lite](https://onyxboox.com/boox_poke4lite). It runs on Android, which means I can install any app from the app store, including my book summary apps. And most importantly, it can install [Google Play Books](https://play.google.com/store/books), which is where I buy most of my books nowadays.
...
The most standard one is [Goodreads](https://www.goodreads.com/), but honestly, the interface is a bit dated and slow. It just feels old.

I tried another app called [Literal](https://literal.club/), and it looked a little nicer with more social features, but the mobile app was so slow I couldn't make myself use it regularly.
