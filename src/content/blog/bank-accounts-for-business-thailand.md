...
To open an account with SCB, you need the following documents: Company Affidavit (หนังสือรับรอง), Certified Copy of Shareholder List (บอจ.5), and Shareholder’s ID.
...
To open an account with KTB, you need a similar set of documents: Company Affidavit (หนังสือรับรอง), Certified Copy of Shareholder List (บอจ.5), Shareholder’s ID, **AND the Board of Directors meeting minutes.**
